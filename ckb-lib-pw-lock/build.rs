...
const SECP256K1_DATA: &str = "secp256k1_data";
const SECP256K1_KECCAK256_SIGHASH_DUAL: &str = "secp256k1_keccak256_sighash_all_dual";
...
fn main() {
    ...
    let cells = vec![
        ("SECP256K1_DATA", SECP256K1_DATA),
        (
            "SECP256K1_KECCAK256_SIGHASH_DUAL",
            SECP256K1_KECCAK256_SIGHASH_DUAL,
        ),
    ];
